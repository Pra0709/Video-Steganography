...
def extract_video_perfect(stego_video, cover_video, extracted_output, alpha=0.078):
...
extract_video_perfect("stego.avi", "cover.mp4", "extracted_secret_perfect.avi", alpha=0.078)